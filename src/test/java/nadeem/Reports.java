...
public class Reports {
	...
	public void checkReportstatus() throws InterruptedException {
		HomePage homepage = new HomePage(Driver);
		ProfilePage profilepage = new ProfilePage(Driver);
		homepage.profilesymbol.click();
		profilepage.reportsbutton.click();
		profilepage.checkreportstatusbutton.click();
		// ResusableMethods.tapWithActions(Driver, 474, 356);
		long startTime = System.currentTimeMillis();
		try {
			profilepage.allbuttoncheckreportstatus.isDisplayed();
			status = "Pass";
		} catch (Exception e) {
			status = "Fail";
			...
			logger.logTableRow("Check Report status", status, endTime - startTime);
		}
	}

	public void Holdingsummaryallassets() throws InterruptedException {
		ProfilePage profilepage = new ProfilePage(Driver);
		profilepage.reportsbutton.click();
		profilepage.ReportsHoldingsummaryallassets.click();
		profilepage.getreportsbutton.click();
		long startTime = System.currentTimeMillis();
		try {
			profilepage.viewstatusbutton.isDisplayed();
			status = "Pass";
		} catch (Exception e) {
			status = "Fail";
			System.out.println("**********" + e + "****************");
			...
			long endTime = System.currentTimeMillis();
			Driver.navigate().back();
			logger.logTableRow("Holding Summary All Assets Report", status, endTime - startTime);
		}
	...
	public void TransactionsSummary() {
		ProfilePage profilepage = new ProfilePage(Driver);
		profilepage.reportsbutton.click();
		profilepage.transactionsummarybutton.click();
		profilepage.getreportsbutton.click();
		long startTime = System.currentTimeMillis();
		try {
			profilepage.viewstatusbutton.isDisplayed();
			...
			long endTime = System.currentTimeMillis();
			Driver.navigate().back();
			logger.logTableRow("Transaction Summary Report", status, endTime - startTime);
		}
	...
	public void capitalgain() {
		ProfilePage profilepage = new ProfilePage(Driver);
		profilepage.reportsbutton.click();
		profilepage.capitalgains.click();
		profilepage.getreportsbutton.click();
		long startTime = System.currentTimeMillis();
		try {
			profilepage.viewstatusbutton.isDisplayed();
			...
			long endTime = System.currentTimeMillis();
			Driver.navigate().back();
			logger.logTableRow("Capital Gains Report", status, endTime - startTime);
		}
	...
	public void ledgerReport() {
		ProfilePage profilepage = new ProfilePage(Driver);
		profilepage.reportsbutton.click();
		profilepage.ledgerreportbutton.click();
		long startTime = System.currentTimeMillis();
		try {
			profilepage.ledgerreportscreen.isDisplayed();
			status = "Pass";
		} catch (Exception e) {
			status = "Fail";
			System.out.println("**********" + e + "****************");
			...
			long endTime = System.currentTimeMillis();
			Driver.navigate().back();
			logger.logTableRow("Ledger Report", status, endTime - startTime);
		}
	...
	public void TradeHistory() {
		ProfilePage profilepage = new ProfilePage(Driver);
		profilepage.reportsbutton.click();
		profilepage.tradehistorybutton.click();
		long startTime = System.currentTimeMillis();
		try {
			profilepage.tradehistoryscreen.isDisplayed();
			status = "Pass";
		} catch (Exception e) {
			status = "Fail";
			System.out.println("**********" + e + "****************");
			...
			long endTime = System.currentTimeMillis();
			Driver.navigate().back();
			logger.logTableRow("Trade History Report", status, endTime - startTime);
		}
	}
	...
	public void PnLReport() {
		ProfilePage profilepage = new ProfilePage(Driver);
		profilepage.reportsbutton.click();
		profilepage.plreportbutton.click();
		long startTime = System.currentTimeMillis();
		try {
			profilepage.pnlreportscreen.isDisplayed();
			status = "Pass";
		} catch (Exception e) {
			status = "Fail";
			System.out.println("**********" + e + "****************");
			...
			long endTime = System.currentTimeMillis();
			Driver.navigate().back();
			logger.logTableRow("P&L Report", status, endTime - startTime);
		}
	}
	...
	public void ContractReport() {
		ProfilePage profilepage = new ProfilePage(Driver);
		profilepage.reportsbutton.click();
		profilepage.contractnotebutton.click();
		long startTime = System.currentTimeMillis();
		try {
			profilepage.contractnotescreen.isDisplayed();
			status = "Pass";
		} catch (Exception e) {
			status = "Fail";
			System.out.println("**********" + e + "****************");
			...
			long endTime = System.currentTimeMillis();
			Driver.navigate().back();
			logger.logTableRow("Contract Report", status, endTime - startTime);
		}
	}
